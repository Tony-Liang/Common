...
namespace LCW.Framework.Common.Util
{
    ...
    {
        public static string[] Dates = { "日", "一", "二", "三", "四", "五", "六" };
        /// <summary>
        /// 根据年月日得出今天是星期几
        /// </summary>
        ...
        public static string WeekOfDay(int year, int month, int day)
        {
            int week = WeekDay(year, month, day);
            string weekStr = null;
            switch (week)
            {
                case 0: weekStr = Week.Monday; break;
                case 1: weekStr = Week.Tuesday; break;
                case 2: weekStr = Week.Wednesday; break;
                case 3: weekStr = Week.Thursday; break;
                case 4: weekStr = Week.Friday; break;
                case 5: weekStr = Week.Saturday; break;
                case 6: weekStr = Week.Sunday; break;
            }
            return weekStr;
        }
        ...
        /// <returns>返回星期几</returns>
        public static string WeekOfDay(string date, string formatString)
        {
            DateTime dt = FormatDateTime(date, formatString);
            string weekStr = null;
            switch (dt.DayOfWeek)
            {
                case DayOfWeek.Monday: weekStr = Week.Monday; break;
                case DayOfWeek.Tuesday: weekStr = Week.Tuesday; break;
                case DayOfWeek.Wednesday: weekStr = Week.Wednesday; break;
                case DayOfWeek.Thursday: weekStr = Week.Thursday; break;
                case DayOfWeek.Friday: weekStr = Week.Friday; break;
                case DayOfWeek.Saturday: weekStr = Week.Saturday; break;
                case DayOfWeek.Sunday: weekStr = Week.Sunday; break;
            }
            return weekStr;
        }

        /// <summary>
        /// 判断时间日期格式大小,oldtime>newtime 返回真 否则返回假
        /// </summary>
        /// <param name="oldtime">长日期格式 yyyy-HH-dd HH:mm:ss</param>
        /// <param name="newtime">长日期格式 yyyy-HH-dd HH:mm:ss</param>
        /// <returns></returns>
        public static bool LongCompare(string oldtime, string newtime)
        {
            if (LongDateTime(oldtime) > LongDateTime(newtime))
            {
                return true;
            }
            return false;
        ...
        /// 判断时间日期格式大小,oldtime>newtime 返回真 否则返回假
        /// </summary>
        /// <param name="oldtime">短日期格式 yyyy-HH-dd</param>
        /// <param name="newtime">短日期格式 yyyy-HH-dd</param>
        /// <returns></returns>
        public static bool ShortCompare(string oldtime, string newtime)
        {
            if (ShortDateTime(oldtime) > ShortDateTime(newtime))
            {
                return true;
            }
            return false;
        ...
        /// <returns></returns>
        public static DateTime FormatDateTime(string date, string formatString)
        {
            System.Globalization.DateTimeFormatInfo provider = new System.Globalization.DateTimeFormatInfo();
            provider.DateSeparator = formatString;
        ...
        /// <param name="date">日期字符串</param>
        /// <returns>返回星期几</returns>
        public static string WeekOfDay(object date)
        {
            return WeekOfDay(date.ToString(), "yyyy-MM-dd");
        }
        ...
        /// <param name="date"></param>
        /// <returns></returns>
        public static DateTime LongDateTime(string date)
        {
        ...
        /// <param name="date"></param>
        /// <returns></returns>
        public static DateTime ShortDateTime(string date)
        {
        ...
        /// <param name="year">年</param>
        /// <param name="month">月</param>
        /// <returns>返回此月的天数</returns>
        public static int DaysInMonth(int year, int month)
        {
            if (year < 1000 || year > 9999)
            {
                //throw new MCException("年超出1000-9999的范围!年为" + year);
            }
            if (month <= 0 || month > 12)
            {
               // throw new MCException("月份超出1-12的范围! 月份为" + month);
            }
        ...
        /// <param name="month">月</param>
        /// <returns>天数</returns>
        public static int LastDayInMonth(int year, int month)
        {
            switch (month)
            {
                case 1:
        ...
        /// <param name="month">月</param>
        /// <returns>天数</returns>
        public static int NextDayInMonth(int year, int month)
        {
            switch (month)
            {
                case 12:
        ...
        public static string Month(int month)
        {
            ...
            switch (month)
            {
                case 1: monthStr = "一月"; break;
                case 2: monthStr = "二月"; break;
                case 3: monthStr = "三月"; break;
                case 4: monthStr = "四月"; break;
                case 5: monthStr = "五月"; break;
                case 6: monthStr = "六月"; break;
                case 7: monthStr = "七月"; break;
                case 8: monthStr = "八月"; break;
                case 9: monthStr = "九月"; break;
                case 10: monthStr = "十月"; break;
                case 11: monthStr = "十一月"; break;
                case 12: monthStr = "十二月"; break;
            }
            return monthStr;
        }
        ...
        public static string Day(int day)
        {
            if (day <= 0 || day > 31)
            {
                //throw new MCException("日期超出1-31的范围! 日期为" + day);
            }
            string dayStr = null;
            switch (day)
            {
                case 1: dayStr = "一号"; break;
                case 2: dayStr = "二号"; break;
                case 3: dayStr = "三号"; break;
                case 4: dayStr = "四号"; break;
                case 5: dayStr = "五号"; break;
                case 6: dayStr = "六号"; break;
                case 7: dayStr = "七号"; break;
                case 8: dayStr = "八号"; break;
                case 9: dayStr = "九号"; break;
                case 10: dayStr = "十号"; break;
                case 11: dayStr = "十一号"; break;
                case 12: dayStr = "十二号"; break;
                case 13: dayStr = "十三号"; break;
                case 14: dayStr = "十四号"; break;
                case 15: dayStr = "十五号"; break;
                case 16: dayStr = "十六号"; break;
                case 17: dayStr = "十七号"; break;
                case 18: dayStr = "十八号"; break;
                case 19: dayStr = "十九号"; break;
                case 20: dayStr = "二十号"; break;
                case 21: dayStr = "二十一号"; break;
                case 22: dayStr = "二十二号"; break;
                case 23: dayStr = "二十三号"; break;
                case 24: dayStr = "二十四号"; break;
                case 25: dayStr = "二十五号"; break;
                case 26: dayStr = "二十六号"; break;
                case 27: dayStr = "二十七号"; break;
                case 28: dayStr = "二十八号"; break;
                case 29: dayStr = "二十九号"; break;
                case 30: dayStr = "三十号"; break;
                case 31: dayStr = "三十一号"; break;
            }
            return dayStr;
        }
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static int MaxDayToWeek(int year, int month)
        {
            return WeekDay(year, month, DaysInMonth(year, month));
        }
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static int MinDayToWeek(int year, int month)
        {
        ...
        /// <param name="day">日</param>
        /// <returns></returns>
        public static string CurrentDay(int year, int month, int day)
        {
        ...
        #region 上一个月,下一个月格式为year-month-day的数据
        /// <summary>
        /// 返回上一月信息
        /// </summary>
        /// <param name="year"></param>
        /// <param name="month"></param>
        /// <returns></returns>
        public static string LastMonth(int year, int month, int day)
        {
            LastMonth(ref year, ref month);
        ...
        /// <summary>
        /// 返回下一月信息,格式为year-month-day;
        /// </summary>
        /// <param name="year"></param>
        /// <param name="month"></param>
        /// <returns></returns>
        public static string NextMonth(int year, int month, int day)
        {
            NextMonth(ref year, ref month);
            if (day > DaysInMonth(year, month))
                day = 1;
            return year + "-" + month + "-" + day;
        }
        ...
        #region 上一个月,下一个月的int类型数据
        /// <summary>
        /// 上一个月信息,ref year ref month
        /// </summary>
        /// <param name="year"></param>
        /// <param name="month"></param>
        /// <returns></returns>
        public static void LastMonth(ref int year, ref int month)
        {
            if (year < 1000 || year > 9999)
            {
                //throw new MCException("年超出1000-9999的范围!年为" + year);
        ...
        /// <summary>
        /// 下一个月的信息,ref year ref month
        /// </summary>
        /// <param name="year"></param>
        /// <param name="month"></param>
        /// <returns></returns>
        public static void NextMonth(ref int year, ref int month)
        {
            if (year < 1000 || year > 9999)
            {
                //throw new MCException("年超出1000-9999的范围!年为" + year);
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static string CurrentMonth(int year, int month)
        {
            return year + "-" + month;
        }
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static int WeekLength(int year, int month)
        {
            int days = DaysInMonth(year, month);
            int minWeek = MinDayToWeek(year, month);
            int maxWeek = MaxDayToWeek(year, month);
            return WeekLength(minWeek, maxWeek, days);
        }

        /// <summary>
        /// 返回一个月的周数
        /// </summary>
        /// <param name="minWeek">第一天是星期几</param>
        /// <param name="maxWeek">最后一天是星期几</param>
        /// <param name="days">这个月的总天数</param>
        /// <returns></returns>
        public static int WeekLength(int minWeek, int maxWeek, int days)
        {
            int weekLength = 0;
            if (minWeek != 6)
            {
            ...
            weekLength += Convert.ToInt32(Math.Ceiling(days / 7.0));
            return weekLength;
        }
        #endregion
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static string LastWeekDays(int year, int month, int day)
        {
            int days = DaysInMonth(year, month);               //本月的总天数
            int lastDays = LastDayInMonth(year, month);        //上月的总天数
            int currentWeek = WeekDay(year, month, day);       //day在本周中为周几
            string monthStr = null;
            int currentYear = year;
            int currentMonth = month;
            if (day - currentWeek - 7 >= 1)                    //当day所处周的上一周处于本月中时
            {
                monthStr = Month(month) + Day(day - currentWeek - 7) + "-" + Month(month) + Day(day - currentWeek - 1);
            }
            else                                               //当day所属周的上一周不处于本月中时
            {
                LastMonth(ref currentYear, ref currentMonth);
                if (day - currentWeek > 1)                     //当day所属周的上一周为本月与上月的集合时
                {
                    monthStr = Month(currentMonth) + Day(lastDays - (7 - day + currentWeek)) + "-" + Month(month) + Day(day - currentWeek - 1);
                }
                else                                           //当day所属周的上一周处于上一个月范围时
                {
                    monthStr = Month(currentMonth) + Day(lastDays - (7 - (day - currentWeek))) + "-" + Month(currentMonth) + Day(lastDays - (currentWeek - day) - 1);
                }
            }
            return monthStr;
        }
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static string CurrentWeekDays(int year, int month, int day)
        {
            int days = DaysInMonth(year, month);               //本月的总天数
            int lastDays = LastDayInMonth(year, month);        //上月的总天数
            int currentWeek = WeekDay(year, month, day);       //day在本周中为周几
            ...
            int currentYear = year;
            int currentMonth = month;
            if (day - currentWeek >= 1 && (day - currentWeek + 6) <= days)                    //当day所处周的上一周处于本月中时
            {
                monthStr = Month(month) + Day(day - currentWeek) + "-" + Month(month) + Day(day - currentWeek + 6);
            }
            else                                              //当day所属周的上一周不处于本月中时
            {
                if (day - currentWeek < 1)
                {
                    LastMonth(ref currentYear, ref currentMonth);
                    monthStr = Month(currentMonth) + Day(lastDays - (currentWeek - day)) + "-" + Month(month) + Day(day - currentWeek + 6);
                }
                else
                {
                    NextMonth(ref currentYear, ref currentMonth);
                    monthStr = Month(month) + Day(day - currentWeek) + "-" + Month(currentMonth) + Day(6 - (days - day + currentWeek));
                }
            }
            return monthStr;
        }
        ...
        /// <param name="month"></param>
        /// <returns></returns>
        public static string NextWeekDays(int year, int month, int day)
        {
            int days = DaysInMonth(year, month);              //本月的总天数
            int currentWeek = WeekDay(year, month, day);      //day在本周中为周几
            string monthStr = null;
            int currentYear = year;
            int currentMonth = month;
            if (day + (6 - currentWeek) + 7 <= days)          //当day所处周的下一周处于本月中时
            {
                monthStr = Month(month) + Day(day + (6 - currentWeek) + 1) + "-" + Month(month) + Day(day + (6 - currentWeek) + 7);
            }
            else                                              //当day所处周的下一周不处于本月范围时   
            {
                NextMonth(ref currentYear, ref currentMonth);
                if (day + (6 - currentWeek) < days)           //当day所处周的下一周从本月开始,次月结束时
                {
                    monthStr = Month(month) + Day(day + (6 - currentWeek) + 1) + "-" + Month(currentMonth) + Day(7 - (days - (day + (6 - currentWeek))));
                }
                else                                          //当day所处周的下一周完全从下一周开始时
                {
                    monthStr = Month(currentMonth) + Day((day + (6 - currentWeek) - days) + 1) + "-" + Month(currentMonth) + Day((day + (6 - currentWeek) - days) + 7);
                }
            }
            return monthStr;
        }
        ...
        /// <param name="day"></param>
        /// <returns></returns>
        public static string LastWeek(int year, int month, int day)
        {
            int lastDays = LastDayInMonth(year, month);       //上月的总天数
            int currentYear = year;
            int currentMonth = month;
            ...
            {
                LastMonth(ref currentYear, ref currentMonth);
                tempDay = lastDays - (7 - day);
            }
            return currentYear + "-" + month + "-" + tempDay;
        }
        ...
        /// <param name="day"></param>
        /// <returns></returns>
        public static string NextWeek(int year, int month, int day)
        {
            int days = DaysInMonth(year, month);       //本月的总天数
            int currentYear = year;
            int currentMonth = month;
        ...
        #region 返回一周内包含的那些日期
        public static System.Collections.ArrayList ContainsWeekDays(int year, int month, int day)
        {
            int days = DaysInMonth(year, month);               //本月的总天数
            int lastDays = LastDayInMonth(year, month);        //上月的总天数
            int currentWeek = WeekDay(year, month, day);       //day在本周中为周几
            ...
            if (day - currentWeek >= 1 && (day - currentWeek + 6) <= days)                    //当day所处周的上一周处于本月中时
            {
                beginDays = day - currentWeek;
                endDays = day - currentWeek + 6;
                for (int i = beginDays; i <= endDays; i++)
                {
                    al.Add(year + "-" + month.ToString().PadLeft(2, '0') + "-" + i.ToString().PadLeft(2, '0'));
                }
            }
            else                                              //当day所属周的上一周不处于本月中时
            {
                ...
                {
                    LastMonth(ref currentYear, ref currentMonth);
                    beginDays = lastDays - (currentWeek - day);
                    endDays = day - currentWeek + 6;
                    for (int i = beginDays; i <= lastDays; i++)
                        al.Add(currentYear + "-" + currentMonth.ToString().PadLeft(2, '0') + "-" + i.ToString().PadLeft(2, '0'));
                ...
                else
                {
                    NextMonth(ref currentYear, ref currentMonth);
                    beginDays = day - currentWeek;
                    endDays = 6 - (days - day + currentWeek);
                    for (int i = beginDays; i <= days; i++)
                        al.Add(year + "-" + month.ToString().PadLeft(2, '0') + "-" + i.ToString().PadLeft(2, '0'));
                    for (int i = 1; i <= endDays; i++)
                        al.Add(currentYear + "-" + currentMonth.ToString().PadLeft(2, '0') + "-" + i.ToString().PadLeft(2, '0'));
                }
        ...
        /// <summary>
        /// 返回一年有多少周，如果周开始于上一年，周数也算在此年。如果周结束于下一年，周数也算在此年。
        /// </summary>
        /// <param name="year"></param>
        /// <returns></returns>
        public static int GetWeekCount(int year)
        {
            System.DateTime dt = DateTime.Parse(year.ToString() + "-01-01");
            int dayCounts = dt.AddYears(1).AddDays(-1).DayOfYear;
            int weeks = dayCounts / 7 + 1;
        ...
        public static void GetContainOfWeek(int year, int month, int day, out DateTime weekStart, out DateTime weekEnd)
        {
            DateTime dt = new DateTime(year, month, day);
            int date = (int)dt.DayOfWeek;
            weekStart = dt.AddDays((int)DayOfWeek.Monday - date);
            weekEnd = dt.AddDays((int)DayOfWeek.Saturday - date + 1);
        }
        ...
        /// <param name="day"></param>
        /// <returns></returns>
        public static int GetCurrentOfWeek(int year, int month, int day)
        {
            DateTime currentDt = new DateTime(year, month, day);
            int week = (int)currentDt.DayOfWeek == 0 ? 7 : (int)currentDt.DayOfWeek;
            int dayCount = currentDt.DayOfYear - week;
            int weeks = 0;
            if (dayCount > 0)
            {
                weeks = dayCount / 7;
